...
HCompV -A -T 2 -D -C $config0 -C $config -f 0.01 -m -S $trainscp -M $traindir/hmm0 $traindir/proto
...
for ph in `cat workdirt/phones1.lst`
do
...
HERest -A -C $config0 -C $config -m 1 -I workdirt/train_phone0.mlf -t 250.0 150.0 1000.0 -S $trainscp -H $traindir/hmm0/hmmdefs.mmf -M $traindir/hmm1 workdirt/phones0.lst
recho "Model $traindir/hmm1/hmmdefs.mmf ready."
HERest -A -C $config0 -C $config -m 1 -I workdirt/train_phone0.mlf -t 250.0 150.0 1000.0 -S $trainscp -H $traindir/hmm1/hmmdefs.mmf -M $traindir/hmm2 workdirt/phones0.lst
recho "Model $traindir/hmm2/hmmdefs.mmf ready."
HERest -A -C $config0 -C $config -m 1 -I workdirt/train_phone0.mlf -t 250.0 150.0 1000.0 -S $trainscp -H $traindir/hmm2/hmmdefs.mmf -M $traindir/hmm3 workdirt/phones0.lst
...
HHEd -H $traindir/hmm4/hmmdefs.mmf -M $traindir/hmm5 config/sil.hed workdirt/phones1.lst
recho "...two more iterations of Embedded Baum-Welch"
HERest -A -C $config0 -C $config -m 1 -I workdirt/train_phone1.mlf -t 250.0 150.0 1000.0 -S $trainscp -H $traindir/hmm5/hmmdefs.mmf -M $traindir/hmm6 workdirt/phones1.lst
recho "Model $traindir/hmm6/hmmdefs.mmf ready."
HERest -A -C $config0 -C $config -m 1 -I workdirt/train_phone1.mlf -t 250.0 150.0 1000.0 -S $trainscp -H $traindir/hmm6/hmmdefs.mmf -M $traindir/hmm7 workdirt/phones1.lst
